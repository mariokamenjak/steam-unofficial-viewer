                 ...
                 Column {
                     Keys.onPressed: {
                         ...
                         if ((event.key == Qt.Key_1) && (event.modifiers & Qt.ControlModifier))
                             webview.url="https://store.steampowered.com/"

                         if ((event.key == Qt.Key_2) && (event.modifiers & Qt.ControlModifier))
                             webview.url="https://steamcommunity.com/"
                         if ((event.key == Qt.Key_3) && (event.modifiers & Qt.ControlModifier))
                             webview.url="https://steamcommunity.com/workshop/"
                         if ((event.key == Qt.Key_Z) && (event.modifiers & Qt.ControlModifier))
                             webview.url="https://steamcommunity.com/greenlight/"
                             /*
                         if ((event.key == Qt.Key_4) && (event.modifiers & Qt.ControlModifier))
                             webview.url="https://lainchan.org/drg/catalog.html"
                         if ((event.key == Qt.Key_5) && (event.modifiers & Qt.ControlModifier))
                             webview.url="https://lainchan.org/lit/catalog.html"
                         if ((event.key == Qt.Key_6) && (event.modifiers & Qt.ControlModifier))
                             webview.url="https://lainchan.org/diy/catalog.html"
                         if ((event.key == Qt.Key_7) && (event.modifiers & Qt.ControlModifier))
                             webview.url="https://lainchan.org/art/catalog.html"
                         if ((event.key == Qt.Key_8) && (event.modifiers & Qt.ControlModifier))
                             webview.url="https://lainchan.org/w/catalog.html"
                         if ((event.key == Qt.Key_9) && (event.modifiers & Qt.ControlModifier))
                             webview.url="https://lainchan.org/rpg/catalog.html"
                         if ((event.key == Qt.Key_0) && (event.modifiers & Qt.ControlModifier))
                             webview.url="https://lainchan.org/r/catalog.html"
                         if ((event.key == Qt.Key_L) && (event.modifiers & Qt.ControlModifier))
                             webview.url="https://lainchan.org/layer/catalog.html"
                         if ((event.key == Qt.Key_K) && (event.modifiers & Qt.ControlModifier))
                             webview.url="https://lainchan.org/q/catalog.html"
                             */
                         if ((event.key == Qt.Key_H) && (event.modifiers & Qt.ControlModifier)){
                             function clpanel()
                             {

                                 if(panel1.opened==true)
                                 {
                                     panel1.close()
                                 }
                                 else
                     ...
                     Panel {
                             ...
                             Rectangle {
                                     ...
                                     /*QtObject {
                                             ...
                                             readonly property var downloadMimeTypesBlacklist: [
                                                 ...
                                                 Component.onCompleted: {
                                                     url = "http://store.steampowered.com/search/?filter=weeklongdeals"
                                 ...
                                 Text
                                 {
                                     ...
                                     text: "Clcik anywhere on the white space and drag it back right. Or press ctrl+h"
                                 }
                             }
                     }
